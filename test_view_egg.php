...
<?php if (isset($result) && !empty($result)): ?>
    <div class="card">
        ...
        <div class="card-body">
            <div>
                <p>Stats</p>
                <div>Current Amount: <?php safer_echo($result["base_rate"]); ?></div>
                <div>Account Min and Max: <?php safer_echo($result["mod_min"]); ?> - <?php safer_echo($result["mod_max"]); ?></div>
                <div>Account Status: <?php getState($result["state"]); ?></div>
